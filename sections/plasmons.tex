...
\begin{document}
    ...
    Стоит отметить, что именно этот параметр определяет коэффициент поглощения $\alpha = \Im q$ при $\Re \omega \gg \Im \omega$: 
    \begin{equation*}
        q(\Re \omega + i \Im \omega) \approx \underbrace{q(\Re \omega)}_{\Re q} + i \underbrace{\Im \omega \left.\frac{\partial q}{\partial \omega}
            \right\vert{}_{\Re \omega}}_{\alpha  = \Im q};
    \end{equation*}
